...
output "iam_role_path" {
  ...
  value       = module.iam_role.iam_role_path
}
...
output "role_requires_mfa" {
  ...
  value       = module.iam_role.role_requires_mfa
}
