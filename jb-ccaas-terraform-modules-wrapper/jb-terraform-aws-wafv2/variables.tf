variable "application" {
  type        = string
  description = "The application name of the wafv2, will be appended with the company, lob, env and region to form a wafv2 name."
}

variable "prefix_company" {
  type        = string
  description = "The prefix company of the wafv2, will be appended with the company, lob, env and region to form a wafv2 name."
}

variable "prefix_region" {
  type        = string
  description = "The prefix region of the aws wafv2 , will be appended with the company, lob, env and region to form a acm name."
}
...
variable "lob" {
  type        = string
  description = "The lob name of the wafv2, will be appended with the company, lob, env and region to form a wafv2 name."
}
