locals {
  users = {
    sales_agent = {
      password             = var.password # Recommended to be passed in through variables if used
...
variable "password" {
  description = "Password for the user. Recommended to be passed in through variables if used."
  type        = string
}