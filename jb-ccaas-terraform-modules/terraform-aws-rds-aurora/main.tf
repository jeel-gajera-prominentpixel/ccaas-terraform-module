...
resource "aws_rds_global_cluster" "this" {
  ...
  engine_version                = var.global_cluster_version
  database_name                 = var.global_cluster_db_name
  # storage_encrypted             = var.global_cluster_storage_encrypted
  source_db_cluster_identifier  = var.global_source_db_cluster_identifier
  force_destroy                 = var.global_cluster_force_destroy
  deletion_protection           = var.global_cluster_deletion_protection
  engine_lifecycle_support      = var.global_cluster_engine_lifecycle_support
}
