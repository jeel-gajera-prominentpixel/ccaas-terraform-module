...
| <a name="input_multi_party_conference_enabled"></a> [multi\_party\_conference\_enabled](#input\_multi\_party\_conference\_enabled) | Specifies whether multi-party calls/conference is enabled. | `bool` | `false` | no |
